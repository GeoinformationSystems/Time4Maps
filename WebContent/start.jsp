...
<html> 
	...
	<script>
		...
		function init() {
			...
			if (empty == "<%=layer%>") {
				if (<%=url.contains("version")%>=="false") location.href = "./layerchooser.jsp?url=<%=url%>&version=<%=version%>";			
				else {
					<%=url=url.replace("?version","&version")%>
					location.href = "./layerchooser.jsp?direct=start&url=<%=url%>";
				}					
			} else {
				initializeMapping(); 
...
<body class="claro" onload="init()">	
	...
	<div id="page" style=""> 		 
	   	...
	   	<div class="header_title"><h1>TIME 4 MAPS</h1></div>	  
		<div class="line"></div>
	</div> 
	<div id="description" class="content_description" style="width:800px;">
	...
	<div id="time" class="content_time">
        ...
        <div id="play">
	  		<div id="playdiv" style="padding-left:550px;padding-top:5px;"><!-- +100 -->
        		<div id="play_div"></div>
        	</div>
        </div>  
	...
	<div class="footer">
		<div id="footer_line" class="line_grey"></div>    
    	<a href="http://tu-dresden.de/die_tu_dresden/fakultaeten/fakultaet_forst_geo_und_hydrowissenschaften/fachrichtung_geowissenschaften/gis">PROFESSUR GEOINFORMATIONSSYSTEME</a>  
	...
	<div id="featureInfo_div" style="left:930px;top:470px;height:180px;width:330px;">  
   	...
   	<div id="layerSwitcherCustom" style="background-color:white;top:162px !important;left:599px;position:absolute;"></div>
   	
   	<div id="printdiv" style="position:absolute; left: 1030px; top: 665px;">
