...
function correctDate(incoming_JSDate, changedDate_Int) {
    ...
    if (period_JSON.day[vis_layer_number] == null && period_JSON.month[vis_layer_number] == null && period_JSON.year[vis_layer_number] == null) {
        ...
        if (dojo.date.difference(new Date(time_JSON.start[vis_layer_number]), incoming_JSDate, 'day') <= 0 && period_JSON.hour[vis_layer_number] <= 0 && period_JSON.minute[vis_layer_number] <= 0 && period_JSON.second[vis_layer_number] <= 0)
