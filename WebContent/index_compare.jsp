...
<head>
	...
	<script>
		...
		var storeData = {
			identifier: 'paramName',items: [ <%=jsonString%> ] 
		};
		var storeData2 = {
				identifier: 'paramName',items: [ <%=jsonString2%> ] 
		};
		function init() { 
...
<body class="claro" style="background-color:#FFFFFF;" onload="init()">	
    ...
    <div dojoType="dojo.data.ItemFileReadStore" data="storeData2" jsId="wmsDescription_Store2"></div>
    <div id="description" class="content_description" style="left:210px;top:-5px;">
        <h2 id="description_wms_title" style="width:490px;position:absolute; left:0px;"></h2>
        <h2 id="description_wms_title2" style="width:490px;position:absolute; left:500px;"></h2>	          
    </div> 
    <div id="map" class="map3" style="left:210px;top:60px;"></div>
    <div id="map2" class="map2" style="left:710px;top:60px;"></div>
    <div id="legendimage" style="position: absolute; top: 60px; left: 10px; z-index: -5;height:280px;width:185px;overflow:auto;">
        <img id="legend_frame"> 
    </div>
    ...
    <div id="time" class="content_time" style="left:280px;top:580px; z-index: -5">
        ...
        <div style="float:left; padding-top:10px; padding-left:70px;z-index:120 !important;">
            ...
            <input id="fromDate_Input" style="z-index:10000 !important;"/>			
        </div>
    ...
    <div id="featureInfo_div" style="left:210px;top:410px;width:950px;height:180px;">  
        <iframe style="border:none;width:475px;height:180px;float:left;" id="featureInfo_frame1" src="featureInfo_compare.jsp"></iframe>  
        <iframe style="border:none;width:475px;height:180px;float:right;" id="featureInfo_frame2" src="featureInfo_compare.jsp"></iframe>  
    </div>
    <div id="printdiv" style="position: absolute; top: 605px; left: 875px; z-index: -5">
